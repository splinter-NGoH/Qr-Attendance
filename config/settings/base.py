...
SIMPLE_JWT = {
    ...
    "SIGNING_KEY": "XSm8lllLNS3Jl9zrOLaGBN27QjnDPmaX05PRJtnEE9B7KUToG43AzE",
...
# STATIC
# ------------------------
STATIC_URL = 'https://%s/static/' % (AWS_S3_ENDPOINT_URL)
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="qr_code ahmedmansy265@gmail.com>",
)
...
SPECTACULAR_SETTINGS["SERVERS"] = [  # noqa F405
    {"url": "https://qr-code.com", "description": "Production server"}
]
# Your stuff...
# ------------------------------------------------------------------------------
